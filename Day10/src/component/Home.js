  ...
  return (
    <div id="home">
      ...
      <main>
        <div className="menu">
          <div className="logo">
            <a href="#">OUTDOOR PLANNING ADVENTURE</a>
          </div>
          <ul>
            <li>
              <a onClick={() => {
            ...
            <li className="services-dropdown" onClick={toggleDropdown}>
              ...
              {isDropdownVisible && (
                <ul className="dropdown">
                  <li>
                    <a href="http://localhost:3000/parking">Luxury Resort</a>
                  </li>
                  <li>
                    <a href="http://localhost:3000/event">Themes</a>
                  </li>
                  <li>
                    <a href="http://localhost:3000/visitor">Destinaton</a>
                  </li>
                  <li>
                    <a onClick={() => {
